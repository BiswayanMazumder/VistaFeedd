...
export default function HomePage_mobile() {
  ...
  return (
    <div className='jhfhvjfhvj' style={{ width: "100vw", height: "93.7vh", display: "flex", justifyContent: "start", alignItems: "start", flexDirection: "column", color: "white", overflowY: "auto", maxHeight: "93.7vh" ,overflowX: "hidden" }}>
        <div className="ebec" style={{ overflowY: "scroll", maxHeight: "100%" }}>
          {
            postImages.length > 0 && (
              postImages.map((image, index) => (
                <div className="jfnvnf" key={index}>
                    ...
                    <div className="jefjn" style={{ marginTop: '10px', fontWeight: '300', fontSize: '14px', width: '500px', display: 'flex', justifyContent: 'start', flexDirection: 'row', gap: '10px',marginLeft:"10px" }}>
