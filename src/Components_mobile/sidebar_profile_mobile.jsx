...
export default function Sidebar_Profile_mobile() {
    ...
    return (
        <div className="jjnd">
            ...
            <Link to={`/profile`} style={{ textDecoration: 'none', color: 'white' }}>
                <div className="hdjvkdv" style={{height:'25px',width:'25px',borderRadius:'50%',marginBottom:'5px'}}>
                    <img src={profilepicture} alt="" height={25} width={25} style={{borderRadius:'50%'}} />
                </div>
            </Link>
        </div>
    )
